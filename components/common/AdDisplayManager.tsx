...
const AdDisplayManager: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-6 animate-in fade-in duration-500">
            ...
            <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col group animate-in zoom-in-95 duration-500">
                <button
                    onClick={handleDismiss}
                    className="absolute top-6 right-6 p-3 bg-white/20 backdrop-blur-xl hover:bg-white text-white hover:text-black rounded-full z-10 transition-all border border-white/10"
                >
                    <X className="w-5 h-5" />
                </button>
                ...
                <div className="aspect-[4/5] relative overflow-hidden bg-slate-100">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-10 text-white">
                        <span className="inline-block px-4 py-1.5 bg-indigo-600 rounded-full text-[9px] font-black uppercase tracking-[0.2em] mb-6">Visual Transmission</span>
                        <h2 className="text-4xl font-black uppercase tracking-tighter mb-4 leading-none">
                            {currentPopup.title}
                        </h2>
                        <p className="text-white/70 text-sm font-medium leading-relaxed mb-10 max-w-xs">
                        ...
                        <a
                            ...
                            onClick={handleDismiss}
                            className="inline-flex items-center gap-4 bg-white text-black px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-slate-100 transition-all shadow-xl"
                        >
